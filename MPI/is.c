...
/*  Get the bucket size totals for the entire problem. These 
    ...
    // MPI_Reduce(bucket_size, bucket_size_totals, NUM_BUCKETS+TEST_ARRAY_SIZE, MP_KEY_TYPE, MPI_SUM, 0, comm_work);
    // MPI_Bcast(bucket_size_totals, NUM_BUCKETS+TEST_ARRAY_SIZE, MP_KEY_TYPE, 0, comm_work);
